...
class AdminSocialItemController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'Social Icon created successfully.');
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'Social Icon updated successfully.');
    ...
    public function delete($id) {
        ...
        return redirect()->route('admin_social_item_show')->with('success', 'Social Icon deleted successfully.');
