...
class AdminSubCategoryController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('admin_sub_category_show')->with('success', 'Subcategory added successfully.');
    ...
    public function delete($id) {
        ...
        return redirect()->route('admin_sub_category_show')->with('success', 'Subcategory has been deleted successfully.');
