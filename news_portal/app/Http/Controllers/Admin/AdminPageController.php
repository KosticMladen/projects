...
class AdminPageController extends Controller
{
    ...
    public function about_update(Request $request) {
        ...
        return redirect()->route('admin_page_about')->with('success', 'About Page is updated successfully.');
    ...
    public function faq_update(Request $request) {
        ...
        return redirect()->route('admin_page_faq')->with('success', 'FAQ Page is updated successfully.');
    ...
    public function terms_update(Request $request) {
        ...
        return redirect()->route('admin_page_terms')->with(
            'success',
            'Terms and Conditions Page updated successfully'
        );
    ...
    public function privacy_update(Request $request) {
        ...
        return redirect()->route('admin_page_privacy')->with('success', 'Privacy Policy Page is updated successfully.');
    ...
    public function login_update(Request $request) {
        ...
        return redirect()->route('admin_page_login')->with('success', 'Login Page is updated successfully.');
    ...
    public function contact_update(Request $request) {
        ...
        return redirect()->route('admin_page_contact')->with('success', 'Contact Page is updated successfully.');
