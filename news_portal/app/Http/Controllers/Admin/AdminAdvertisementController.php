...
class AdminAdvertisementController extends Controller
{
    ...
    public function sidebar_ad_store(Request $request) {
        ...
        return redirect()->route('admin_sidebar_ad_show')->with('success', 'Ad created successfully.');
    ...
    public function sidebar_ad_update(Request $request, $id) {
        ...
        return redirect()->route('admin_sidebar_ad_show')->with('success', 'Data updated successfully.');
