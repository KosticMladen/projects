...
class AdminLiveChannelController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('admin_live_channel_show')->with('success', 'Live Channel created successfully.');
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('admin_live_channel_show')->with('success', 'Live Channel is updated successfully.');
    ...
    public function delete($id) {
        ...
        return redirect()->route('admin_live_channel_show')->with('success', 'Live Channel is deleted successfully.');
