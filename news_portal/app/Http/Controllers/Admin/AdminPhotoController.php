...
class AdminPhotoController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('admin_photo_show')->with('success', 'Photo added successfully.');
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('admin_photo_show')->with('success', 'Picture updated successfully.');
    ...
    public function delete($id) {
        ...
        return redirect()->route('admin_photo_show')->with('success', 'Picture is deleted successfully.');
