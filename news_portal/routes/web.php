...
Route::post('/forgot-password-submit', [LoginController::class, 'forgot_password_submit'])->name('forgot_password_submit');
...
Route::get('/admin/sidebar-advertisement-veiw', [AdminAdvertisementController::class, 'sidebar_ad_show'])->name('admin_sidebar_ad_show')->middleware('admin:admin');
...
// Admin Subscribers
Route::get('/admin/subscriber/all', [AdminSubscriberController::class, 'show_all'])->name('admin_subscribers');
