                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div class="pt_0 tab-pane fade" id="v-2" role="tabpanel" aria-labelledby="v-2-tab">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset('uploads/' . $setting_data->logo) }}" alt="existing-logo" style="width: 250px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset('uploads/' . $setting_data->favicon) }}" alt="existing-favicon">
                                            </div>
                                        </div>
                                    ...
                                    <div class="pt_0 tab-pane fade" id="v-6" role="tabpanel" aria-labelledby="v-6-tab">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="disqus_code" class="form-control" cols="30" rows="10" style="height: 200px">
