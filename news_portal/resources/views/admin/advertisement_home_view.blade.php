                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div>
                                <img src="{{ asset('uploads/' . $home_ad_data->above_search_ad) }}" alt="advertisement" style="width: 100%;">
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            <label>Existing Photo</label>
                            <div>
                                <img src="{{ asset('uploads/' . $home_ad_data->above_footer_ad) }}" alt="advertisement" style="width: 100%;">
                            </div>
                        </div>
