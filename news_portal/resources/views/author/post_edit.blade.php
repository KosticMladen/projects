                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div>
                                <img src="{{ asset('uploads/' . $post_single->post_photo) }}" alt="post-photo" style="width: 300px;">
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered">
                                    @foreach($existing_tags as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('author_post_delete_tag', [$item->id, $post_single->id]) }}" class="btn btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                            </td>
                                        </tr>
