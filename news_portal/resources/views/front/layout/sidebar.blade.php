    ...
    @foreach($global_sidebar_top_ad as $row)
        ...
        <div class="ad-sidebar">
            @if($row->sidebar_ad_url == '')
                ...
                <img src="{{ asset('uploads/' . $row->sidebar_ad) }}" alt="sidebar-ad">

            @else
            
                <a href="{{ $row->sidebar_ad_url }}"><img src="{{ asset('uploads/' . $row->sidebar_ad) }}" alt="sidebar-ad"></a>
...
<div class="widget">
    ...
    <div class="poll">
        <div class="question">
            <b>{{ $global_online_poll_data->question }}</b>
        </div>
        ...
        @if(session()->get('current_poll_id') == $global_online_poll_data->id)
            ...
            <div class="poll-result">                        
                ...
                <a href="{{ route('poll_previous') }}" class="btn btn-primary old" style="margin-top: 0;">Old Results</a>
            </div>
            ...
            <div class="answer-option">
                <form action="{{ route('poll_submit') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <a href="{{ route('poll_previous') }}" class="btn btn-primary old">Old Results</a>
                    </div>
