            ...
            <div class="col-lg-8 col-md-12 left">
                ...
                @foreach($post_data as $item)
                    ...
                    <div class="inner">
                        <div class="photo">
                            <div class="bg"></div>
                            <img src="{{ asset('uploads/' . $item->post_photo) }}" alt="post-photo">
                            <div class="text">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @else
                    <a href="{{ $home_ad_data->above_search_ad_url }}"><img src="{{ asset('uploads/' . $home_ad_data->above_search_ad) }}" alt="advertisement"></a>
                @endif
                                    ...
                                    <div class="right-side">
                                        ...
                                        @foreach($item->rPost as $single)
                                            ...
                                            <div class="right-side-item mb-2">
                                                <div class="left">
                                                    <img src="{{ asset('uploads/' . $single->post_photo) }}" alt="post-photo">
                                                </div>
                                                <div class="right">
                                                    <div class="category">
                                                        <span class="badge bg-success">{{ $item->sub_category_name }}</span>
                    ...
                    @foreach($video_data as $item)
                        ...
                        <div class="item">
                            <div class="video-thumb">
                                <img src="http://img.youtube.com/vi/{{ $item->video_id }}/0.jpg" alt="video-thumbnail">
                                <div class="bg"></div>
                                <div class="icon">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                @else
                    <a href="{{ $home_ad_data->above_footer_ad_url }}"><img src="{{ asset('uploads/' . $home_ad_data->above_footer_ad) }}" alt="advertisement"></a>
                @endif
