                ...
                <div class="accordion" id="accordionExample">
                    ...
                    @foreach($faq_data as $item)
                        ...
                        <div class="accordion-item">
                            ...
                            <button
                                class="accordion-button @if($loop->iteration != 1) collapsed @endif" type="button"
                                data-bs-toggle="collapse"
                                data-bs-target="#collapse{{ $i }}"
                                aria-expanded="@if($loop->iteration == 1) true @else false @endif" aria-controls="collapse{{ $i }}"
                            >
                                {{ $item->faq_title }}
                            </button>
                            </h2>
